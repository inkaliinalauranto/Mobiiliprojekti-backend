...
@app.get("/api/measurement/consumption/total/seven_days_before_date/{date}")
...
@app.get("/api/measurement/consumption/total/hourly/{date}")
...
@app.get("/api/measurement/consumption/total/daily/{date}")
